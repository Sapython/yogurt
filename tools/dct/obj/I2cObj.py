...
from data.I2cData import BusData, I2cData
    ...
    def fill_dtsiFile(self):
        ...
        for i in range(0, I2cData._channel_count):
            ...
            for key in sorted_key(list(ModuleObj.get_data(self).keys())):
                ...
                if (
                    cmp(value.get_channel(), channel) == 0
                    and cmp(value.get_varName(), "NC") != 0
                    and value.get_address().strip() != ""
                ):
                    gen_str += """\t%s@%s {\n""" % (
